...
L0208:	dw	03d4h	; length of valid bitmap ((code_len + 7) / 8)
	...
	db	0,0,0,0,0,0,0,0a9h,19h,0afh,'2',0b5h,19h,0eh,' ',1eh
	db	0ffh,0cdh,0abh,0dh,'2"',21h,0afh,'2',0a8h,19h,0afh,'2',0fdh
	db	' 2',0ffh,' ',21h,0f1h,' ',11h,0e5h,1eh,1,'$',0,0edh,0b0h
	db	11h,0e5h,1eh,0cdh,'5',1dh,'<',0cah,8eh,19h,0afh,'2',5,1fh,'2'
	db	0f1h,1eh,21h,0,1,'"',0b3h,19h,0edh,'[',0b3h,19h,0cdh,'%',1dh
	db	':',7,0,'=',0bch,0cah,0dbh,0ah,'*',0b3h,19h,11h,80h,0,19h,'"'
	db	0b3h,19h,11h,0e5h,1eh,0cdh,'-',1dh,0b7h,'(',0dbh,11h,80h,0
	db	0cdh,'%',1dh,':Q',1bh,'2',0a7h,1eh,0cdh,0ah,1dh,0cdh
